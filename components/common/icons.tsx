  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M13.23 0.47C13.53 0.76 13.53 1.24 13.23 1.53L12.06 2.7L9.3 0L10.47 1.17C10.76 1.46 11.24 1.46 11.53 1.17L13.23 0.53C13.53 0.82 13.53 1.3 13.23 1.59V0.47ZM11 3.76L2.76 12C2.54 12.23 2.36 12.5 2.26 12.81L1.24 16H3.75L4.5 15.25V13.5H6.25L7 12.75H3.75L3 12V10.25L2.25 9.5V13L1.5 13.75V15.25L1.74 16L4.93 14.98C5.24 14.88 5.51 14.71 5.74 14.48L13.98 6.24L11 3.26V3.76ZM8.3 1L0 9.3V12L3.06 12.06L11.3 3.7L8.3 0.7V1Z"
        fill="currentColor"
      />
    </svg>
  );
